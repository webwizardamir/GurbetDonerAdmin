...
export function getDefaultTemplate(type: EmailDocumentType): EmailTemplate {
  return { ...DEFAULT_TEMPLATES[type] }
}

/** Resolve a per-type template from the saved map, falling back to defaults. */
export function getTemplate(map: EmailTemplateMap | null | undefined, type: EmailDocumentType): EmailTemplate {
