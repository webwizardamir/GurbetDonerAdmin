...
const NL = {
  ...
  poIntro: (asAt: string) =>
    `Hieronder vindt u een overzicht van de facturen die volgens onze administratie op ${asAt} vervallen zijn en nog openstaan.`,
  poAlreadyPaid:
...
const EN: typeof NL = {
  ...
  poIntro: (asAt: string) =>
    `Below is an overview of the invoices that, according to our records, were past their due date and still unpaid on ${asAt}.`,
  poAlreadyPaid:
